...
const Home = () => {
    ...
    return (
        <>
            <section className="mx-auto min-h-[60vh] flex justify-center align-center flex-col bg-slate-200">
                <div>
                    <h1 className="font-extrabold text-[#222328] dark:text-slate-100 text-[64px] text-center">Let's create something special!</h1>
                    <p className="my-10 text-[#666e75] text-[14px] max-w-[500px] md:max-w-full text-center">Welcome to the world of AI generated images! Shall we begin?</p>
                    <Link to="/createpost" className='font-inter m-auto block max-w-full md:max-w-xs text-center font-bold bg-[#272727] dark:bg-slate-500 text-white dark:text-slate-100 px-4 py-2 rounded-md'>LET'S GO!</Link>
                </div>
            </section>
